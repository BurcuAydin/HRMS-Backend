...
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 4 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    title character varying(255) NOT NULL,
    PRIMARY KEY (id)
);

CREATE TABLE public.system_personnel_confirm_employers
(
    id integer NOT NULL,
...
CREATE TABLE public.system_personnel_confirms
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
ALTER TABLE public.system_personnel_confirm_employers
...
ALTER TABLE public.system_personnel_confirm_employers
    ADD FOREIGN KEY (id)
    REFERENCES public.system_personnel_confirms (id)
    NOT VALID;


ALTER TABLE public.system_personnel_confirms
